...
function commandPeticio() {
	// Variables locals
	var urlCodi = "http://localhost/daw2_m07uf1_projecte_grup09/accions/eliminarproducte.php?n=";
	var metode = "DELETE";
	// Dades rebudes d'HTML
	var nomComanda = document.forms['formulari'].elements["form_codeproduct"].value;
...
function netForm() {
	...
	document.forms['formulari'].elements["form_codeproduct"].value ="";
	location.reload();
}